...
<div id="main-wrap">
  <div id="main">
    ...
    <ul>
      ...
      <li>Les résultats s'afficheront directement dans le panneau ;</li>
    ...
    <h2>Une remarque, un problème, signalez-le</h2>

    <p>Si vous rencontrez un problème, souhaitez nous proposer des améliorations ou simplement
    donner votre avis sur l'outil, n'hésitez pas à <a
    href="https://reporting.opquast.com/projects/19559/issues/new">créer un ticket sur ce
    projet</a>.</p>
    ...
    <p>Vous utilisez Opquast Desktop version {{! it.version }}.</p>
    ...
    <h3>Référentiels fournis</h3>

    <table>
      <caption>Référentiels</caption>
      <thead>
        <tr>
          <th>Référentiel</th>
    ...
    <h3>Autres logiciels utilisés</h3>
