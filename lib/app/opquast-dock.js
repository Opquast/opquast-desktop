...
const {emit, on} = require("api-utils/event/core");
const {EventTarget} = require("api-utils/event/target");
const {Class} = require("api-utils/heritage");

const {BaseDock, DockCache} = require("app/dock");
const {ResultPanel} = require("app/panels/results");
...
let OpquastDock = Class({
    ...
    createPanel: function createPanel(aRunTests) {
        ...
        debug.debug("Panel created");

        return box;
    },

    findPanel: function findPanel(aURL) {
        debug.debug("Search panel with URL: " + aURL);
