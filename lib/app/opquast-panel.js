...
const {exportReporting} = require("tools/export/reporting");
...
let OpquastPanel = exports.OpquastPanel = Class({
    ...
    initToolbar: function initToolbar() {
        ...
        this.controls.exp_reporting = _X("menuitem", {
            "class": this.dock.options.id + "-exportreporting",
    ...
    tbExportReporting: function tbExportReporting(evt) {
        ...
        let win = this.iframe1.contentWindow.wrappedJSObject;
        let result = exportReporting(this.iframe1, this.iframe2, this, this.dock.getCurrentTabWindow(), win.tests);
        if(!result) {
            this.tbCancelExport();
        }
    },
