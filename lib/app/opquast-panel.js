...
let OpquastPanel = exports.OpquastPanel = Class({
    ...
    showUI: function showUI(aForce) {
        ...
        if(entry && (entry.tests == undefined || entry.tests.oaa_results == undefined || entry.tests.oaa_results[0].criterion == undefined)) {
            entry = null;
        }
        ...
        if (aForce || cache) {
            ...
            let loadResults = function(evt) {
                try {
                    this.iframe1.removeEventListener("DOMContentLoaded", loadResults, false);
                    let doc = evt.target;
            ...
            this.iframe1.addEventListener("DOMContentLoaded", loadResults, false);
        } else {
    ...
    tbExportEARL: function tbExportEARL(evt) {
        ...
        let win = this.iframe1.contentWindow.wrappedJSObject;
        exportEARL(this.iframe1, this.iframe2, this.deck, this.dock.getCurrentTabWindow(), win.tests);
    },
