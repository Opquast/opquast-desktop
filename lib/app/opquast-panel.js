...
const {init, inputFilter, clearFilter, sort} = require("tools/tree");
...
let OpquastPanel = exports.OpquastPanel = Class({
    ...
    initTreeView: function initTreeView() {
		...
		treecols.appendChild(splitter.cloneNode());*/
