...
const workerFor = (page) => workers.get(page);
const pageFor = (view) => pages.get(view);
const viewFor = (page) => views.get(page);
const isDisposed = (page) => !views.get(page, false);
...
const isValidURL = (page, url) => {return !page.rules || page.rules.matchesAny(url) }
