...
const ResultPanel = exports.ResultPanel = Class({
    ...
    initToolbar: function initToolbar() {
        ...
        on(this.controls.search, "input", this.tbSearch.bind(this), false);
    ...
    showUI: function showUI(aForce) {
        ...
        if (aForce || cache) {
            ...
            this.loadMessage(load_msg, this.resultUI.bind(this, cache));
        } else {
            // No cache, not forcing tests, show landing page
            this.loadPage("ui/blank.html", this.landingUI.bind(this));
        }
    },
    ...
    landingUI: function landingUI(evt) {
        ...
        on(b, "click", this.tbLaunch.bind(this), false);
