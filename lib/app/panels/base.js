...
const FrameWorker = require('./frameWorker');
...
const BasePanel = exports.BasePanel = Class({
    ...
    tbResize: function tbResize(evt) {
        try {
    ...
    frameWorker: function frameWorker(options, additionalScripts) {
        options = mix({
            ...
            "contentScriptFile": [
                ...
                self.data.url("lib/jquery-ui-1.10.4.min.js"),
            ...
            "contentScriptOptions": {
                ...
                "templates": {
                    ...
                    'tplConfirmDelete': self.data.load("ui/templates/confirmDelete.tpl"),
        ...
        if (options.onFrameReady) {
            let onFrameReady = options.onFrameReady;
            options.onFrameReady = function(worker) {
        ...
        return FrameWorker.Frame(options);
    },

    get tabBrowser() {
        return this.parent.dock.getCurrentTabBrowser();
    },

    get tabURL() {
        return this.parent.dock.getCurrentURL();
    },
    get browserWindow() {
        return this.parent.dock.getBrowserWindow();
    },
});
