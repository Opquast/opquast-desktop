...
const checklists = exports.checklists = {
    ...
    "568-firstStep": {
        name: "Accessibility First Step",
        langs: ["en", "fr"],
    },
    "567-secondStep": {
        name: "Accessibility Second Step",
        langs: ["en", "fr"],
    },
    "597-accessiweb": {
        name: "Accessiweb deployé",
        langs: ["fr"],
    },
    "599-accessiweb": {
        name: "Accessiweb non deployée",
        langs: ["fr"],
    },
    "601-sgqri": {
        name: "SGQRI",
...
if (prefs.checklists === undefined) {
    let loc = require("api-utils/l10n/core").locale().toLowerCase();
