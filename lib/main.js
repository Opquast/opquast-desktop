...
exports.main = function(aOptions, aCallback) {
    ...
    // Log configuration
    if (aOptions.staticArgs && aOptions.staticArgs.logLevel) {
    ...
    if (aOptions.staticArgs && aOptions.staticArgs.api) {
    ...
    // Requests logger: install a tab listener that will activate
    // a har collector in each new tab
    TabRequestsLogger();
