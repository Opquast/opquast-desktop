...
const {ToolbarButton} = require("tools/toolbarbutton");
const {SplitPanel} = require("tools/split-panel");
...
exports.main = function(aOptions, aCallback) {
    ...
    // Panel
    SplitPanel(mainPanel.panelOptions);

    // Toolbar Button
    let button = ToolbarButton(mainPanel.buttonOptions);
