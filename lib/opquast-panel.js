...
let ResultsUI = function(aContentWindow, aFrame, aCache) {
    ...
    let load = function() {
        ...
        win._testFeedback = TestFeedback.bind(this);
...
let TestFeedback = function(aValue) {
    let feedback_url = _("oqs.feedback_url")
        + "?title=" + encodeURIComponent(_("oqs.feedback_title"))
        + "&desc=" + encodeURIComponent(_("oqs.feedback_content", aValue.test_id, aValue.test_name, aValue.checklist));
