...
exports.showPanel = function(aContentWindow, aCache) {
    ...
    if (aCache) {
	    ...
	    let _Launch = Launch.bind(this, aContentWindow, frame, null);
	    this.doc.getElementById(_this.options.id + "-launchbutton").removeEventListener("command", _Launch, aCache, true);
