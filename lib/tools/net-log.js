...
let getRequestInfo = function(aRequest, aListener) {
    ...
    try {
        out[uri] = aRequest.URI.spec;
        out[referrer] = aRequest.referrer != null ? aRequest.referrer.spec : "";
        out[method] = aRequest.requestMethod;
        out[status] = aRequest.responseStatus;
        out[status_text] = unescape(encodeURIComponent(aRequest.responseStatusText));
    } catch(e) {}
