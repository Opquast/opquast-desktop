...
const on = exports.on = function(target, type, listener, capture) {
...
const once = exports.once = function(target, type, listener, capture) {
    capture = (capture == undefined) ? false : capture;
    target.addEventListener(type, function _listener(evt) {
        try {
            target.removeEventListener(type, _listener, capture);
            listener.apply(this, arguments);
        } catch(e) {
            console.exception(e);
            throw e;
